...
export const menuAnimales = async () => {
    ...
    console.log('3.- Mandar a la base de datos') // carga el animal que hayamos introducido en la base de datos que tenemos configurada
    console.log('4.- Cargar los datos de un animal') // Pide un nombre y lanza los datos de dicho animal
    console.log('5.- Calculos de animal') // Cambia los datos de un animal localizado por su nombre
    console.log('6.- Liberar animal') // Borra a un animal
    console.log('0.- SALIR')
